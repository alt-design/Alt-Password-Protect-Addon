...
class Data
{
    ...
    public function __construct($type)
    {
        ...
        if (!$this->manager->disk()->exists('content/alt-password-protect')) {
            $this->manager->disk()->makeDirectory('content/alt-password-protect');
        }

        // Grab the current file we're working with
        $this->currentFile = $this->manager->disk()->get('content/alt-password-protect/' . $this->type . '.yaml');
    ...
    public function setAll($data)
    {
        ...
        $this->manager->disk()->put('content/alt-password-protect/' . $this->type . '.yaml', Yaml::dump($this->data));
    }
